...
sealed class GenericApiResponse<T> {
    // sealed class is a super enum and can catch all the subclasses that inherit from them in this case
    // to catch whether if error, success or empty

    companion object {
        // two builders that handle the response whether error, success or empty
