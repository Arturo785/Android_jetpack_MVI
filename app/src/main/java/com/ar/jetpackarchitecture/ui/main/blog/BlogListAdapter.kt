...
import com.ar.jetpackarchitecture.util.GenericViewHolder
...
class BlogListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        // to inflate the correct view depending on which viewType we got
        when(viewType){
    ...
    // needed to avoid weird behaviour on the recyclerView
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        return differ.currentList[position].pk // -1 means exhausted
    }
